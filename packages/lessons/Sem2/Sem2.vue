...
import SectionSem2Top from 'Lessons/Sem2/components/SectionSem2Top';
import SectionSem2Intro from 'Lessons/Sem2/components/SectionSem2Intro';
        ...
        if (this.lessonData.instructionSets) {
            ...
            this.instructionGroups.forEach(group => {
                ...
                group.questions.forEach(q => {
                    ...
                    this.instructionMap.push(group.instructionText); // One instruction per question
